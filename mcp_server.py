...
def edit_document(
    ...
    old_str: str = Field(description="The text to replace. Must exactly, including whitespace."),
...
@mcp.prompt(
    name="format",
    description="Rewrite the contents of the docuement in markdown format."
)
def format_document(
